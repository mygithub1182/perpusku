export default function CardPinjamanSaya(props){
    ...
    <>
          <div className="col-sm-6 col-lg-4 item" style={{color: 'var(--bs-dark)'}}><img className="img-fluid" src={props.imgUrl} style={{height: '258.141px'}} />
            ...
            <p className="description" style={{marginBottom: 10, marginTop: 7}}>{props.deskripsi}<br /></p><a href='pengembaliansukses'><button className="btn btn-primary" type="button" style={{borderRadius: 41, borderTopColor: 'var(--bs-gray-dark)', background: 'rgb(0,0,0)'}}>Kembalikan</button></a>
          </div>
    </>
    )
