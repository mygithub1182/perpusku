    ...
    return(
        ...
        <div className="row" style={{borderBottomStyle: 'solid', borderBottomColor: 'var(--bs-blue)'}}>
                ...
                <div className="col" style={{filter: 'blur(0px)'}}>
                    ...
                    <p>ID Pinjam : {props.idPinjam} | Tgl-Pinjam : {props.tglPinjam}<br /></p><a href="/kembali"><button className="btn btn-primary" type="button" style={{fontFamily: '#2E8B57', borderRadius: 68, background: '#2E8B57'}}>Kembalikan</button></a>
                </div>
            </div>
        </div>
    )
